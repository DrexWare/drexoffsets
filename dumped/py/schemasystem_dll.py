...
class CExampleSchemaVData_Monomorphic:
    m_nExample1 = 0  # offset
    m_nExample2 = 4  # offset
...
class CSchemaSystemInternalRegistration:
    m_CTransform = 256  # offset
    m_CUtlBinaryBlock = 296  # offset
    m_CUtlString = 312  # offset
    m_CUtlSymbol = 320  # offset
    m_Color = 224  # offset
    m_DegreeEuler = 100  # offset
    m_KV3 = 360  # offset
    m_QAngle = 64  # offset
    m_Quaternion = 48  # offset
    m_QuaternionStorage = 112  # offset
    m_RadianEuler = 88  # offset
    m_ResourceTypes = 352  # offset
    m_RotationVector = 76  # offset
    m_Vector = 8  # offset
    m_Vector2D = 0  # offset
    m_Vector4D = 228  # offset
    m_VectorAligned = 32  # offset
    m_VectorWS = 20  # offset
    m_matrix3x4_t = 128  # offset
    m_matrix3x4a_t = 176  # offset
    m_pKeyValues = 288  # offset
    m_stringToken = 324  # offset
    m_stringTokenWithStorage = 328  # offset
